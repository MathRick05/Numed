...
import { CreateCaregiverDependentDto } from "@caregiver-dependents/application/dto/create-caregiver-dependent.dto";
...
export class CaregiverDependentsController {
  ...
  async remove(@Param("caregiverId") caregiverId: string, @Param("dependentId") dependentId: string) {
