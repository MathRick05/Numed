...
export class HateoasInterceptor implements NestInterceptor {
  ...
  private transformList(
    ...
    return {
      ...
      _links: {
        self: {
          href: `${basePath}?_page=${page}&_limit=${limit}`,
          method: "GET",
        },
        next:
          page < totalPages
            ? {
                href: `${basePath}?_page=${page + 1}&_limit=${limit}`,
                method: "GET",
              }
            : null,
        prev:
          page > 1
            ...
            : null,
        first: { href: `${basePath}?_page=1&_limit=${limit}`, method: "GET" },
        last: {
          href: `${basePath}?_page=${totalPages}&_limit=${limit}`,
          method: "GET",
        },
