...
export class MedicineDto {
  ...
  @ApiProperty({ enum: MedicineType }) tipo: MedicineType;
  @ApiProperty() numeroDosagem: number;
  @ApiProperty({ enum: DosageUnit }) unidadeDosagem: DosageUnit;
  @ApiProperty() quantidadeGuardada: number;
  @ApiProperty() instrucoes: string;
  ...
  static from(medicine: Medicine | null): MedicineDto | null {
