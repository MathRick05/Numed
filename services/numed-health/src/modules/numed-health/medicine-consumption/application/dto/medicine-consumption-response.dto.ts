...
export class MedicineConsumptionResponseDto {
  ...
  @ApiProperty({ enum: TreatmentDurationUnit }) duracaoUnidade: TreatmentDurationUnit;
  @ApiProperty({ nullable: true }) duracaoValor: number | null;
  @ApiProperty({ isArray: true, type: ConsumptionTimeDto }) horarios: ConsumptionTimeDto[];
