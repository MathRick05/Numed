...
const QUEUES = {
  userCreated: "numed-health.user-auth.users.created.queue",
  userUpdated: "numed-health.user-auth.users.updated.queue",
  userDeleted: "numed-health.user-auth.users.deleted.queue",
} as const;
